...
osThreadId Float_To_U32_TaHandle;
...
void Start_Float_To_U32_Task(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(BOOT_Task, Start_BOOT_Task, osPriorityIdle, 0, 128);
  ...
  /* definition and creation of Float_To_U32_Ta */
  osThreadDef(Float_To_U32_Ta, Start_Float_To_U32_Task, osPriorityIdle, 0, 128);
  Float_To_U32_TaHandle = osThreadCreate(osThread(Float_To_U32_Ta), NULL);
...
/* USER CODE BEGIN Header_Start_Float_To_U32_Task */
/**
* @brief Function implementing the Float_To_U32_Ta thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_Float_To_U32_Task */
void Start_Float_To_U32_Task(void const * argument)
{
  /* USER CODE BEGIN Start_Float_To_U32_Task */
  /* Infinite loop */
  float value = 2.32;
  float value2 = 4.95;
  for(;;)
  {
    Float_To_U32(value,value2,0);
	osDelay(500);
  }
  /* USER CODE END Start_Float_To_U32_Task */
}
